...
- Standard process facilite easy onboarding of new projects and members. It ensure openness by-design

- Standard operations and library of standard operators guaranty by design the desired level of compatibillity between processes and datasets. 
...
### Distribution of Effort: Core Component, Apps, Code Library and Local Time Machines

To maximize growth of the Time Machine environment, the right balance must be found between part of the infrastructure under the control of the **Time Machine Organisation** and pieces of software independantly developped. The Time Machine should be as distributed as possible but as centralized as necessary.
...
- The **Local Time Machine Operations** are the list of basic operations produced by **Projects** and concerning the **Municipality**. They appear as log of activies in the **Local Time Machines Webspace**.  The **Local Time Machine Densitiy of Operations** characterises the amounty of activities going on in the **Local Time Machine**. It characterises both the activities that are going on inside **Projects** and for Crowdsourcing activities. Standards values of activities defines a scale to represent Local Time Machine (**RFC on LTM Value Scale**, planned 2020)
...
Processes for organising local time machine event willl also be discussed in a separated RFC
