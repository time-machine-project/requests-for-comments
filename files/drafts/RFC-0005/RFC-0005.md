...
**Local Time Machines** focus on **Municipalities**, i.e. zone of territories dividing the surface of earth on administratively non ambigous zones. The list of **Municipalities** is therefore the potential Local Time Machine is fixed and predetermined. 

**Projects** focuses on a **Zone of Coverage** corresponding to one of several **GeoEntities**. The list of  based on existing geographical entities (e.g. a list of Places documents in Open Street Map (OSM)) defines as standard Geographical Information System objects (points - lines - polygons). 


The **GeoEnttites** are a fixed list of entities that defines the list of potential **Local Time Machines**. 
...
The **4D Map** will be defined by a dedicated RFC (**Not currently planned in RFC2**)
...
The **Project Environment** includes basic tools for perfoming Internal Operations on **Projects**
   ...
   3. Updating the list **GeoEntities** on which the **Project** operates (the first version of this list  is automatically generated by the selection on the **Local Time Machines Map** using the  **Zone of Coverage** )
...
Step 2: Adding a Location from the list of **GeoEntities** : 


![50 % center](LTM_Project_Geographic_AddLocation.jpg)

Step 2: Defining a **Zone of Coverage** to select a list of **GeoEntities** : 

![50 % center](LTM_Project_Geographic_ZoneofCoverage.jpg)

Step 2: Editing the list of  **GeoEntities**  associated with the **Project**
...
###  Phase III : Development of the Mirror World Environment 
...
Each parcel has a unique ID in the Time Machine system.
