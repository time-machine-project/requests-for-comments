...
### Core Component, Apps and Local Time Machines
...
The **Code Library** is a library accesible in Python (and possibly later other language) regrouping key function for processing Data in the Time Machine Environment. 
...
- Projects can contribute to the **Code Library** by working on the github repository of the Time Machine.
...
Navigator are the equivalent of Browsers on the World Wide Web. They interpret the **Data Graph** and the **4D Map** to create different processes for exploration. Various typologies of Navigators can be designed : 

1. Search Engines (including Visual Search Engines)
...
Peform state of the art HTR transcription in document. 

##### 2D -> 3D segmenter

Using homologous point network, this operator uses 2D segmentation to segment 3D objects
