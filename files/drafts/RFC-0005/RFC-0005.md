...
The **4D Map** is a organised as a hierachy of **Places**. 

The **4D Map** can be navigated using the several **4D interfaces** 
...
It correspons to a list on **Places** (e.g. a list of cities). The **Zone of Coverage** can be defined using the **4D interfaces**


###  Local Time Machine

A **Local Time Machine** is defined as the activities and results of the **Projects** and **Use Cases** happening in a **Place**

It is associated with a **Local Time Machine Activities** and **Local Time Machine Community**

###  Local Time Activities

(tbd)

###  Local Time Community

(tbd)

###  4D interfaces

The 4D interfaces can be application-based or web-based. They can be for desktop or mobile. 

By default, the mobile version may not feature more of the project editing tools. 
