...
(A SYNTHETIC SCHEMA MUST BE INSERTED HERE)
...
- The **Local Time Machine Densitiy of Operations** characterises the amounty of activities going on in the **Local Time Machine**. It characterises both the activities that are going on inside **Projects** and for Crowdsourcing activities. Standards values of activities defines a scale to represent Local Time Machine (**RFC on LTM Value Scale**, planned 2020)
