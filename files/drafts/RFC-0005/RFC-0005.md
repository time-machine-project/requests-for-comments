...
It correspons to a list on **Places** (e.g. a list of cities) and a **Temporal Slice**. The **Zone of Coverage** can be defined using the **4D interfaces**
