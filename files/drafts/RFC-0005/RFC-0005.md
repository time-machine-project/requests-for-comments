...
- The curation of hte **Code Library** regrouping key functions for processing Data in the Time Machine Environment. 
...
If the project is primarely meant for mining data it follows the following steps : Name and Period, Geographic Coverage, Description, Public Data and Review/Publish
...
###  Phase II : Development of the App and Environment
