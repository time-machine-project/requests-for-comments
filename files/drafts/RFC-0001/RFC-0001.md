...
Conflict Detectors
:   Specialized **Apps** that detects incoherence in the **Data Graph** and help users to solve them. 

Data Graph
:   A formal representation of knowledge extracted by human or automatic process, represented with semantic web technology.
